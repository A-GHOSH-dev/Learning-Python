...
class Statistics():
    def __init__(self, finallist, columnlist, columnlist1, rowlist, mean1, mean2):
...
#sample variance 
 ...
 #sample variance ho   
    ...
    def correlation(self, arg, args):
        #mean1=sum(self.columnlist)/len(self.columnlist)
        #mean2=sum(self.columnlist1)/len(self.columnlist1)
        ...
        corr1=(len(self.finallist)*sum(multiply)) - ((sum(self.columnlist))*(sum(self.columnlist1)))
...
genobj = Statistics(finallist, columnlist, columnlist1, rowlist, mean1, mean2)
#accessing attribute values
print("Variance sample: ")
print(genobj.variance(rowlist))
print("Variance sample higher order: ")
print(genobj.higerorder_variance(rowlist))
print("Variance population: ")
print(genobj.variancesample(finallist))
print("Variance population higher order: ")
print(genobj.higerorder_variancesample(finallist))
print("Pearson Correlation: ")
print(genobj.correlation(columnlist, columnlist1))
print("Linear Correlation: ")
print(genobj.lincorrelation(columnlist, columnlist1))
print("Sample Correlation: ")
print(genobj.samplecorrelation(columnlist, columnlist1))
print("Population Correlation: ")
print(genobj.popcorrelation(columnlist, columnlist1))
print("Regression: ")
print(genobj.regression(columnlist, columnlist1))
